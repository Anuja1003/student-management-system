                ...
                <Container>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="ms-auto">
                            <Nav.Link as={NavLink} to="/admin/profile" className="nav-item navItemStyle" >Profile</Nav.Link>
                            <Nav.Link as={NavLink} to="/admin/changePassword" className="nav-item navItemStyle" >Change Password</Nav.Link>
                            <Nav.Link as={NavLink} to="/admin/AllStudents" className="nav-item navItemStyle" >All Students</Nav.Link>
                            <Nav.Link as={NavLink} to="/admin/Attendance" className="nav-item navItemStyle" >Attendance</Nav.Link>
                            <Nav.Link as={NavLink} to="/admin/Result" className="nav-item navItemStyle" >Result</Nav.Link>
                            <Nav.Link as={NavLink} to="/admin/PendingUsers" className="nav-item navItemStyle" >Pending Students</Nav.Link>
